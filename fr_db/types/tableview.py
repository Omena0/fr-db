...
class TableView(Table):
    ...
    def _apply_ops_to_rows(self, rows: dict[int, Row] | RowView) -> dict[int, Row] | RowView:
        """Apply pending operations to a given set of rows.\n
            ...
            :type rows: dict[int, Row] | RowView
        """
        from .operation import Operation
    ...
    def _apply_ops(self) -> None:
        """Apply pending operations and clear them."""
    ...
    def rows(self) -> RowView | dict[int, Row]:
        """Return the view's rows, applying pending operations first."""
        self._apply_ops()
        return self._rows
    ...
    def rows(self, value: RowView | dict[int, Row]) -> None:
        ...
        self._rows = value # pyright: ignore[reportIncompatibleVariableOverride]
    ...
    def columns(self) -> dict[str, Column[Any]]:
        """Return the view's columns, applying pending operations first."""
        self._apply_ops()
